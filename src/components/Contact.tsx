    ...
    <section id="contact" className="section contact-section">
      <div className="section-container">
        <div ref={ref} className="reveal contact-card">
          <div><p className="eyebrow">Contact</p><h2>Get in touch.</h2><p>I’m looking for data science and ML engineering roles. Email me about a role, a project, or a research collaboration.</p></div>
